...
/*****************************INSERTING MERCHANT PRODUCT INFO******************************/
INSERT INTO MerchantProducts(MID, PID)
VALUES("MM000", "PP000");
...
INSERT INTO Reviews(RID, PID, Author, ProductName, ReviewDescription, Stars)
VALUES("RR000", "PP000", "User1", "T-Shirt", "Nice material!", 5);

INSERT INTO Reviews(RID, PID, Author, ProductName, ReviewDescription, Stars)
VALUES("RR111", "PP222", "User2", "Table", "Size is too big", 3);

INSERT INTO Reviews(RID, PID, Author, ProductName, ReviewDescription, Stars)
VALUES("RR222", "PP555", "User2", "Bread", "Very fresh!", 4);
